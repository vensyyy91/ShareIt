...
class ItemControllerTest {
    ...
    void getAllItems_withUserIdAndWithoutParams_shouldReturnOk() {
        ...
        verify(itemService).getAllItems(1, 0, 10);
    }
    ...
    void addItem_withEmptyName_shouldReturnBadRequest() {
        ItemDto item = new ItemDto(1L, null, "first test item description", true, null);
    ...
    void addItem_withEmptyDescription_shouldReturnBadRequest() {
        ItemDto item = new ItemDto(1L, "item1", null, true, null);
    ...
    void addItem_withoutAvailable_shouldReturnBadRequest() {
        ItemDto item = new ItemDto(1L, "item1", "first test item description", null, null);
    ...
    void searchItem_withoutFromAndSizeParams_shouldReturnOk() {
        mvc.perform(get(ITEMS_PATH + "/search").param("text", "first item"))
                .andExpect(status().isOk());

        verify(itemService).searchItem("first item", 0, 10);
    }
    ...
    void addComment_withEmptyText_shouldReturnBadRequest() {
        CommentDto comment = new CommentDto(1L, "", "user1", LocalDateTime.now());
