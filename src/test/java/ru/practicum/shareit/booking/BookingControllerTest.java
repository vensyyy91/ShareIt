...
class BookingControllerTest {
    ...
    @Test
    @SneakyThrows
    void getBooking_withoutUserId_shouldReturnOk() {
    ...
    void getUserBookings_withUserIdAndWithoutParams_shouldReturnOk() {
        ...
        verify(bookingService).getUserBookings(1, State.ALL, 0, 10);
    }
    ...
    void getUserItemsBookings_withUserIdAndWithoutParams_shouldReturnOk() {
        ...
        verify(bookingService).getUserItemsBookings(1, State.ALL, 0, 10);
    }
